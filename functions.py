# functions in pythons are defined with a key word def followed by an identifier (a name for example) then the body contains the code to be run when the function is called.
